    ...
    return(
        <div className="md:h-[90vh] min-h-[80vh] flex md:ml-0 md:mr-0 ml-10 mr-10 justify-center items-center">
            <div className="">
                ...
                <Bounce triggerOnce><button className="text-lg text-[#64ffda] px-5 py-3 rounded-md bg-transparent border border-[#64ffda] mt-10 hover:bg-[#64ffda] hover:text-black" onClick={ButtonOnClick}>Check out my Resume!</button></Bounce>
            </div>
        </div>
    );
}